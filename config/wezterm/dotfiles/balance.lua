...
local function balance_panes_func(axis)
...
M.balance_panes_x = balance_panes_func("x")
M.balance_panes_y = balance_panes_func("y")
M.balance_panes = function(...)
  M.balance_panes_x(...)
  M.balance_panes_y(...)
end
...
function M.apply_to_config(config)
  ...
  table.insert(config.keys, {
    key = "=",
    mods = "LEADER",
    action = wezterm.action_callback(M.balance_panes),
  })
