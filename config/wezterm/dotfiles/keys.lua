...
function M.apply_to_config(config)
  ...
  M.bind(config, {
    { MOD, "A", wezterm.action.ShowLauncherArgs({ flags = "TABS|FUZZY" }) },
    { MOD, "B", wezterm.action.PaneSelect({ mode = "MoveToNewWindow" }) },
    { MOD, "C", wezterm.action.CopyTo("Clipboard") },
    { MOD, "D", wezterm.action.ShowLauncherArgs({ flags = "DOMAINS|FUZZY" }) },
    { MOD, "E", action.quick_select_open }, -- https://loganlinn.com
    { MOD, "F", wezterm.action.QuickSelect },
    { MOD, "G", wezterm.action.ShowLauncherArgs({ flags = "LAUNCH_MENU_ITEMS|FUZZY" }) },
    ...
    { MOD, "O", wezterm.action.ActivateLastTab },
    ...
    { MOD, "LeftArrow", wezterm.action.AdjustPaneSize({ "Left", 10 }) },
    { MOD, "RightArrow", wezterm.action.AdjustPaneSize({ "Right", 10 }) },
    { MOD, "UpArrow", wezterm.action.AdjustPaneSize({ "Up", 5 }) },
    { MOD, "Numpad1", wezterm.action.Nop },
    { MOD, "Numpad2", wezterm.action.Nop },
    { MOD, "Numpad3", wezterm.action.Nop },
    { MOD, "Numpad4", wezterm.action.Nop },
    { MOD, "Numpad5", wezterm.action.Nop },
    { MOD, "Numpad6", wezterm.action.Nop },
    { MOD, "Numpad7", wezterm.action.Nop },
    { MOD, "Numpad8", wezterm.action.Nop },
    { MOD, "Numpad9", wezterm.action.Nop },
    { MOD, "Numpad0", wezterm.action.Nop },
    ...
    { MOD, "$", action.switch_to_workspace_4 },
    ...
    { SUPER_SHIFT, "W", wezterm.action.CloseCurrentTab({ confirm = true }) },
    ...
    { LEADER, "h", wezterm.action.SplitPane({ top_level = true, direction = "Left" }) },
    { LEADER, "j", wezterm.action.SplitPane({ top_level = true, direction = "Down" }) },
    { LEADER, "k", wezterm.action.SplitPane({ top_level = true, direction = "Up" }) },
    { LEADER, "l", wezterm.action.SplitPane({ top_level = true, direction = "Right" }) },

    { SUPER, "h", wezterm.action.SplitPane({ direction = "Left" }) },
    { SUPER, "j", wezterm.action.SplitPane({ direction = "Down" }) },
    { SUPER, "k", wezterm.action.SplitPane({ direction = "Up" }) },
    { SUPER, "l", wezterm.action.SplitPane({ direction = "Right" }) },
