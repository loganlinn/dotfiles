...
in
{
  ...
  xdg.configFile =
    let
      cfgSymlink =
        name: config.lib.file.mkOutOfStoreSymlink "${config.my.flakeDirectory}/config/kitty/${name}";
    in
    mkIf cfg.enable {
      "kitty/keyboard.conf".source = cfgSymlink "keyboard.conf";
      "kitty/mouse.conf".source = cfgSymlink "mouse.conf";
      "kitty/open-actions.conf".source = cfgSymlink "open-actions.conf";
      "kitty/quick-access-terminal.conf".source = cfgSymlink "quick-access-terminal.conf";
      "kitty/theme.conf".source = cfgSymlink "theme.conf";
      "kitty/diff".source = cfgSymlink "diff.conf";
      ...
      "kitty/grab.conf".source = cfgSymlink "grab.conf";
    };
