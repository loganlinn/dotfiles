#!/usr/bin/env bash
#
# uses neovim for [kitty scrollback buffer](https://sw.kovidgoyal.net/kitty/overview/#the-scrollback-buffer).
#
# credit: https://github.com/kovidgoyal/kitty/issues/719#issuecomment-1380466143
