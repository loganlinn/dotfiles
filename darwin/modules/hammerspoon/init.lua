...
modes.main:bind(HYPER, "-", function()
	modes.main:exit()
end)
...
modes.main:bind(HYPER, "2", appSwitcher({ name = "Linear" }))
modes.main:bind(HYPER, "3", appSwitcher({ name = "Notion" }))
modes.main:bind(HYPER, "4", appSwitcher({ name = "Claude" }))
modes.main:bind(HYPER, "4", appSwitcher({ name = "ChatGPT" }))
modes.main:bind(HYPER, "5", appSwitcher({ name = "Devin.ai" }))
...
if spoon.editWithEmacs then
	...
	local bindings = {
		edit_selection = { { "alt", "ctrl" }, "e" },
		edit_all = { { "alt", "ctrl", "shift" }, "e" },
	}
