...
_aws-okta_cred-process()
{
    ...
    must_have_one_flag=()
    must_have_one_noun=()
    must_have_one_noun+=("DANGER-customers")
    must_have_one_noun+=("DANGER-datainfrard")
    must_have_one_noun+=("DANGER-devel")
    must_have_one_noun+=("DANGER-devops")
    must_have_one_noun+=("DANGER-global")
    must_have_one_noun+=("DANGER-main")
    must_have_one_noun+=("appbe")
    must_have_one_noun+=("customers")
    must_have_one_noun+=("datainfrard")
    must_have_one_noun+=("devel")
    must_have_one_noun+=("devops")
    must_have_one_noun+=("distsys")
    must_have_one_noun+=("eng")
    must_have_one_noun+=("global")
    must_have_one_noun+=("main")
